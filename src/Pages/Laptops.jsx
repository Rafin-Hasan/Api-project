              ...
              <div className=" mt-1 list-disc p-5 h-[200px] ">
                ...
                <div className="btn flex gap-1 items-center mt-2 mb-2">
                  <button
                    ...
                    className="w-full h-[40px] font-poppins font-semibold text-white bg-[#06D001] p-3 flex justify-center items-center gap-2 rounded-tl-3xl hover:bg-white hover:text-black border-solid border-[#059212] hover:border-2"
                  >
                    Details
                  </button>
                  <button
                    onClick={() => handleadd(item)}
                    className="w-full h-[40px] font-poppins font-semibold text-white bg-[#06D001] p-3 flex justify-center items-center gap-2 rounded-br-3xl hover:bg-white hover:text-black border-solid border-[#059212] hover:border-2"
                  >
                    Add to cart
                  </button>
                </div>
